        ...
        try {
          ...
          const selectedMainModel = await vscode.window.showQuickPick(
            modelOptions,
            {
              ...
              placeHolder: "Choose the main model for Claude Code",
            },
          );
          ...
          const selectedFastModel = await vscode.window.showQuickPick(
            modelOptions,
            {
              title: "Select Fast Model (ANTHROPIC_SMALL_FAST_MODEL)",
              placeHolder: "Choose the fast model for Claude Code",
            },
          );
          ...
          const authToken = currentToken
            ? currentToken
            : "This settings is generated by Agent Maestro :)";
