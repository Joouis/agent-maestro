...
- Fix "unexpected `tool_use_id` found in `tool_result` blocks" 400 errors by calibrating Anthropic token counts with linear regression to trigger auto-compact before context window limit is exceeded
